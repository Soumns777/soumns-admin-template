...
<template>
  <div class="w-full h-screen dataScreen-container" box-border flex flex-col>
    <!-- 头部 -->
    <div flex w="100%" h="38px" bg-green-100>头部</div>
    ...
    <div flex box-border p="20px l40px">
      ...
      <div flex flex-col>
        ...
        <div w="287px" h="221px" m="t20px" bg-pink-500>男女比例</div>
        <div w="287px" h="198px" m="t20px" bg-blue-500>年龄比例</div>
      </div>
      ...
      <div flex flex-col m="l40px" box-border>
        ...
        <div w="706px" h="184px" m="t16px" bg-orange-500>
          未来30天客流量趋势图
        </div>
      </div>
      ...
      <div flex flex-col m="l40px">
        <div w="287px" h="272px" bg-red-500>热门景区排行</div>
        <div w="287px" h="221px" m="t20px" bg-green-500>年度游客量对比</div>
        <div w="287px" h="198px" m="t20px" bg-cyan-500>预约渠道数量统计</div>
      </div>
    </div>
  </div>
</template>
